      ...
      <div className="footer-container">
        <div className="footer-brand">
          ...
          <div className="footer-socials">
            {/* facebook icon */}
            <a href="https://www.facebook.com/profile.php?id=61578767222980" target="_blank" className="social-icon">
            ...
            {/* whatsapp icon */}
            <a href="https://wa.me/8801712972683" target="_blank" className="social-icon">
